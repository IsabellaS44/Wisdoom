...
<main>
    ...
    <section class="articles-top-section">
        <div class="container-lg">
            <h2 class="visually-hidden">Topplista böcker</h2>
            <div class="row g-5">
                <div class="col-md-6">
                    <div class="feature-card feature-card-large">
                        ...
                        <img src="assets/images/books/bok2.png" alt="bild på dok n.1" class="article-img-large">
    ...
    <section class="articles-featured-section">
        <div class="container-lg">
            <h2 class="visually-hidden">Utvald bok</h2>
            <div class="articles-featured-card">
                ...
                <div class="articles-featured-content">
                    ...
                    <div class="articles-featured-buttons">
                        ...
                        <button type="button" class="btn btn-outline-secondary">
                            <span class="text-danger-emphasis"><u>Lyssna på dokumentär</u><i class="fa-solid fa-volume-high fa-xl ms-2"></i></span>
                        </button>
                    </div>
